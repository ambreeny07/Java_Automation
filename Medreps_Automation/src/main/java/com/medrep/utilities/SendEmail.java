...
public class SendEmail extends BaseClass {
	...
	final String password = "Xoz20698";	
        ...
        try {
            ...
            message.setFrom(new InternetAddress("automatedtestingemails@medreps.com"));
            
            message.setRecipients(Message.RecipientType.TO,
                InternetAddress.parse("ambreeny4191@gmail.com,ambreeny007@hotmail.com,automatedtestingemails@medreps.com,testingresults@biospace.com"));
